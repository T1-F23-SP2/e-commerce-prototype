...
import com.example.ecommerceprototype.oms.OutDatedClasses.Items;
...
//                com.example.ecommerceprototype.OMS.OutDatedClasses.Items inst = new com.example.ecommerceprototype.OMS.OutDatedClasses.Items((ObjectId)cursorIterator.next().get("_id"), (String)cursorIterator.next().get("Name"), (String)cursorIterator.next().get("Address"), (int)cursorIterator.next().get("Phone"), (String)cursorIterator.next().get("City"), (int)cursorIterator.next().get("ZipCode"));
