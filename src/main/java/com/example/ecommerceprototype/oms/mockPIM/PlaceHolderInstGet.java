...
public class PlaceHolderInstGet {
    ...
    static ProductInformation inst1 = new ProductInformation("1U2U3I4D1", "Iphone v", "123456789", "An amazing iphone v Short Desc", "This iphone v can this and this Long Desc", false, null, null, null, new PriceInformation(new BigDecimal("9999.99"), new BigDecimal("8000"), LocalDate.of(2023, 3, 10), null));
    ...
    static ProductInformation inst3 = new ProductInformation("1U2U3I4D3", "LG Tv", "123456987", "An amazing LG Tv Short Desc", "This LG Tv can this and this Long Desc", false, null, null, null, new PriceInformation(new BigDecimal("99999"), new BigDecimal("50000"), LocalDate.of(2023, 5, 12), null));
